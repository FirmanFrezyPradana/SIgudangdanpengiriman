            ...
            <div class="w-full p-4 max-h-10 sm:rounded-lg">
                ...
                <div class="grid md:grid-cols-1 justify-items-end gap-6 mt-4">
                    ...
                    <div class="">
                        ...
                        <input type="text" wire:model="totalHarga" id="visitors" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                    </div>
                    <div class="">
