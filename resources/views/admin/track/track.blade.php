...
<div class="mb-5">
    <label for="kode_pengiriman" class="text-lg mb-2 text-gray-300 block">Masukkan kode pengiriman</label>
    <input type="text" name="kode_pengiriman" id="" class="border p-2 rounded-lg w-36 focus:border-blue-600 focus:outline-none">
